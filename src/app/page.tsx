...
function LinkedInIcon() {
  return (
    <svg
      ...
      fill="currentColor"
    >
      <path d="M100 0C44.8 0 0 44.8 0 100s44.8 100 100 100h-1c13.6 0 24 10.4 24 24v276c0 13.6-10.4 24-24 24h1c-55.2 0-100-44.8-100-100s44.8-100 100-100zm-76 400h-1c-13.6 0-24-10.4-24-24s10.4-24 24-24h1c13.6 0 24 10.4 24 24s-10.4 24-24 24zm336-220c-61.6 0-112 50.4-112 112v4h-76v-4c0-44.8 36.8-80.8 82.4-80.8s80.8 36 80.8 80.8v144h-1c-24 0-44.8 20-44.8 44.8v76h-76c-4.8 0-8-4-8-8v-220h-76v4c0 44.8 36 80.8 80.8 80.8h1v144c0 24-20 44.8-44.8 44.8h-76v-276h76v36h1c13.6-24 41.6-40 74.4-40 61.6 0 112 50.4 112 112v220h-76v-220z" />
    </svg>
  );
}
       ...
       <div className="flex text-center w-full">
         <div className="w-10 h-10">
           {image && (
             ...
             {!image && ( // Conditionally render icons based on title
            <>
